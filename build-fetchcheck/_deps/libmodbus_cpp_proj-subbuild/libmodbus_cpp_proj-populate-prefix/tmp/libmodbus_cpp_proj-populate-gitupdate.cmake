...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/markus/PROJECTS/caparoc-utils/waveshare_modbus_commander/build-fetchcheck/_deps/libmodbus_cpp_proj-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/markus/PROJECTS/caparoc-utils/waveshare_modbus_commander/build-fetchcheck/_deps/libmodbus_cpp_proj-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
